...
String[] labels = {"FILE", "LINES", "POINTS", "TEXT", "SHADING"};
...
String[] labels3 = {"Select Area", "Colour", "Delete Shade"};
Button[] sub4 = new Button[3];
String[] labels4 = {"Clear","Export PNG", "Export SVG"};
